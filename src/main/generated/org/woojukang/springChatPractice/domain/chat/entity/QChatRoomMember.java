...
public class QChatRoomMember extends EntityPathBase<ChatRoomMember> {
    ...
    public final org.woojukang.springChatPractice.domain.user.entity.QUser user;
    ...
    public QChatRoomMember(Class<? extends ChatRoomMember> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new org.woojukang.springChatPractice.domain.user.entity.QUser(forProperty("user")) : null;
    }
