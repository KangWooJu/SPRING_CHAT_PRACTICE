...
public class QChatMessage extends EntityPathBase<ChatMessage> {
    ...
    public final org.woojukang.springChatPractice.domain.user.entity.QUser sender;
    ...
    public QChatMessage(Class<? extends ChatMessage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.sender = inits.isInitialized("sender") ? new org.woojukang.springChatPractice.domain.user.entity.QUser(forProperty("sender")) : null;
    }
